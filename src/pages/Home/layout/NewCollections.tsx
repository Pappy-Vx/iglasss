  ...
  return (
    <section className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
       <div className="overflow-hidden w-full h-[500px] lg:h-[800px] bg-[#96887D] rounded-md">
        ...
        <button className='bg-[#3D3834] hover:bg-white hover:text-[#3D3834] text-white px-4 py-2 rounded-full text-2xl w-76 h-14 mt-18 text-bold cursor-pointer'>Get yours here</button>
        </div>
       </div>
       <div className="overflow-hidden w-full h-[500px] lg:h-[800px] bg-[#E7E7E7] rounded-md">
        <img src={collect2} alt="" />
        <h3 className='text-3xl font-bold text-[#506D4E] ml-5 mt-8'>Kids Wear</h3>
        ...
        <div className='flex items-center justify-center'>
        <button className='bg-[#A1BF9F] hover:bg-white hover:text-[#A1BF9F] text-white px-4 py-2 rounded-full text-2xl w-76 h-14 mt-24 text-bold cursor-pointer'>Get yours here</button>
        </div>
       </div>
      </div>
    </section>
