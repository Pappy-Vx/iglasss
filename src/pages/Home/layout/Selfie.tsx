...
const Selfie = () => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-6'>
        ...
        <Link to={routePath.GlassTryOn}  className='bg-[#330011] hover:bg-white hover:text-[#330011] text-white px-4 py-2 rounded-full text-2xl w-76 h-14 mt-24 text-bold cursor-pointer text-center border-[#330011] border-2'>Try Hair</Link>
        </div>
    </div>
  )
}
